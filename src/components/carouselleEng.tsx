          ...
          <div className="w-full h-full mx-auto overflow-x-hidden overflow-y-hidden">
            ...
            >
              <div className="flex flex-shrink-0 relative w-full sm:w-auto ">
                {/* from here */}
                <Link
                  href="/product/Raw-Shea-Butter-Hydrate-Repair-Shampoo?lang=eng"
                  passHref
                >
                    ...
                    <div className="borderradiuscarousel bg-gray-200 bg-opacity-20 absolute w-full h-full p-6">
                      ...
                      <div className="flex h-full items-end pb-6">
                        <h3 className="text-xl lg:text-xl font-semibold leading-5 lg:leading-6 text-black dark:text-white">
                          Rav Shea Butter Hydrate Repair Shampoo
                        </h3>
                      </div>
                    </div>
                  </div>
              ...
              <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                {/* from here */}
                <Link
                  href="/product/Virgin-Coconut-Oil-Daily-Hydration-Shampoo?lang=eng"
                  passHref
                >
                  <div className="wrap object-cover overflow-hidden w-[296px] h-[485px] hover:bg-white">
                    <Image
                    ...
                    <div className="borderradiuscarousel bg-gray-200 bg-opacity-20 absolute w-full h-full p-6">
                      ...
                      <div className="flex h-full items-end pb-6">
                        <h3 className="text-xl lg:text-xl font-semibold leading-5 lg:leading-6 text-black dark:text-white">
                          Virgin Coconut Oil Daily Hydration Shampoo
                        </h3>
                      </div>
                    </div>
                  </div>
              ...
              <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                {/* from here */}
                <Link
                  href="/product/Jamaican-Black-Castor-Oil-Strengthen&Restore-Shampoo?lang=eng"
                  passHref
                >
                  <div className="wrap object-cover overflow-hidden w-[296px] h-[485px] hover:bg-white">
                    <Image
                    ...
                    <div className="borderradiuscarousel bg-gray-200 bg-opacity-20 absolute w-full h-full p-6">
                      ...
                      <div className="flex h-full items-end pb-6">
                        <h3 className="text-xl lg:text-xl font-semibold leading-5 lg:leading-6 text-black dark:text-white">
                          Jamaican Black Castor Oil Shampo
                        </h3>
                      </div>
                    </div>
                  </div>
              ...
              <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                {/* from here */}
                <Link
                  href="/product/Hydrate-&-Repair-Honey-&-Yogurt-Shampoo?lang=eng"
                  passHref
                >
                  <div className="wrap object-cover overflow-hidden w-[296px] h-[485px] hover:bg-white">
                    <Image
                    ...
                    <div className="borderradiuscarousel bg-gray-200 bg-opacity-20 absolute w-full h-full p-6">
                      ...
                      <div className="flex h-full items-end pb-6">
                        <h3 className="text-xl lg:text-xl font-semibold leading-5 lg:leading-6 text-black dark:text-white">
                          Hydrate & Repair Honey & Yogurt Shampoo
                        </h3>
                      </div>
                    </div>
                  </div>
              ...
              <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                {/* from here */}
                <Link
                  href="/product/Raw-Shea-Butter-Hydrate-Repair-Conditioner?lang=eng"
                  passHref
                >
                  <div className="wrap object-cover overflow-hidden w-[296px] h-[485px] hover:bg-white">
                    <Image
                    ...
                    <div className="borderradiuscarousel bg-gray-200 bg-opacity-20 absolute w-full h-full p-6">
                      ...
                      <div className="flex h-full items-end pb-6">
                        <h3 className="text-xl lg:text-xl font-semibold leading-5 lg:leading-6 text-black dark:text-white">
                          Raw Shea Butter Hydrate Repair Conditioner
                        </h3>
                      </div>
                    </div>
                  </div>
              ...
              <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                {/* from here */}
                <Link
                  href="/product/Virgin-Coconut-Oil-Daily-Hydration-Conditioner?lang=eng"
                  passHref
                >
                  <div className="wrap object-cover overflow-hidden w-[296px] h-[485px] hover:bg-white">
                    <Image
                    ...
                    <div className="borderradiuscarousel bg-gray-200 bg-opacity-20 absolute w-full h-full p-6">
                      ...
                      <div className="flex h-full items-end pb-6">
                        <h3 className="text-xl lg:text-xl font-semibold leading-5 lg:leading-6 text-black dark:text-white">
                          Virgin Coconut Oil Daily Hydration Conditioner
                        </h3>
                      </div>
                    </div>
                  </div>
              ...
              <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                {/* from here */}
                <Link
                  href="/product/Jamaican-Black-Castor-Oil-Strengthen&Restore-Conditioner?lang=eng"
                  passHref
                >
                  <div className="wrap object-cover overflow-hidden w-[296px] h-[485px] hover:bg-white">
                    <Image
              ...
              <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                {/* from here */}
                <Link
                  href="/product/Hydrate-&-Repair-Honey-&-Yogurt-Conditioner?lang=eng"
                  passHref
                >
                  <div className="wrap object-cover overflow-hidden w-[296px] h-[485px] hover:bg-white">
                    <Image
                    ...
                    <div className="borderradiuscarousel bg-gray-200 bg-opacity-20 absolute w-full h-full p-6">
                      ...
                      <div className="flex h-full items-end pb-6">
                        <h3 className="text-xl lg:text-xl font-semibold leading-5 lg:leading-6 text-black dark:text-white">
                          Hydrate & Repair Honey & Yogurt Conditioner
                        </h3>
                      </div>
                    </div>
                  </div>
              ...
              <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                {/* from here */}
                <Link href="/product/Turmeric-Powder?lang=eng" passHref>
                  <div className="wrap object-cover overflow-hidden w-[296px] h-[485px] hover:bg-white">
                    <Image
                      loader={() =>
